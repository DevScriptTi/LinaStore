...
export function ProductFilters({
  ...
  return (
    <div className="p-5 rounded-3xl bg-white dark:bg-[#1C1B1F] border border-gray-200 dark:border-white/10 shadow-sm space-y-5 select-none" dir="rtl">
      
      {/* Header */}
      <div className="flex items-center gap-2 text-gray-900 dark:text-white pb-3 border-b border-gray-100 dark:border-white/10">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="اكتب ما تحث عنه هنا..."
            value={searchTerm}
